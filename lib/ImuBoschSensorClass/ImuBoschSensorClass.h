...
*/
#ifndef _ImuBoschSensorClass_H_
#define _ImuBoschSensorClass_H_
...
class ImuBoschSensorClass : public GenImu{
  public:
    
    ImuBoschSensorClass(TwoWire& wire = Wire);
    ~ImuBoschSensorClass() {}
...
extern ImuBoschSensorClass IMU_BMI270_BMM150;
#undef IMUBMI270
#define IMUBMI270 IMU_BMI270_BMM150
#endif